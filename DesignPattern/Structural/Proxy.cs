...
namespace DesignPattern.Structural
{
	...
	public class Payment : IPayment
	{
		...
		{
			string response = $"Paid to Mr./Mrs./Miss. {this.RecepientName} Amount INR. {amount}/- [From A/C: {this.AccoutnNumber}, Bank: {this.BankName}] On date of {this.PaymentDate.ToString(CultureInfo.InvariantCulture)}";
